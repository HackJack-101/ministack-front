    ...
    <div className="p-8">
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <div
          ...
          onDrop={handleDrop}
          className={`border-2 border-dashed rounded-card p-10 text-center cursor-pointer transition-colors group ${
            isDragging
              ? "border-blue-500 bg-blue-500/10"
              : "border-border-strong hover:border-blue-500/50 hover:bg-blue-500/5"
          }`}
        >
          <input
            type="file"
