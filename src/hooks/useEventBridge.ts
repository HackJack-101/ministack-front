...
export const useEventBridge = () => {
  ...
  const fetchRules = useCallback(async (eventBusName: string) => {
    try {
  ...
  const createEventBus = useCallback(async (name: string) => {
    try {
  ...
  const deleteEventBus = useCallback(async (name: string) => {
    try {
  ...
  const putEvents = useCallback(async (busName: string, source: string, detailType: string, detail: string) => {
    try {
